...
.header-v1 .navbar-default .navbar-nav>li>a:focus {
  color: <?php echo $keyColor; ?>;
  border-bottom-color: <?php echo $keyColor; ?>;
}

.header-v1 .dropdown-menu {
  border-color: <?php echo $keyColor; ?>;
  border-top: 2px solid <?php echo $keyColor; ?>;
}

.headline h2,
.headline h3,
.headline h4 {
  border-bottom: 2px solid <?php echo $keyColor; ?>;
}
...
<?php if ( !empty($options['keyColorDark'])): $keyColorDark=$options['keyColorDark'];?>
...
.btn-u.active,
.open .dropdown-toggle.btn-u {
  background: <?php echo $keyColorDark; ?>;
  color: #fff;
}

.pagination li a:hover {
  background: <?php echo $keyColorDark; ?>;
  border-color: <?php echo $keyColorDark; ?>;
}
